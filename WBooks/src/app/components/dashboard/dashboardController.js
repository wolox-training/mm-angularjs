angular.module('app-bootstrap').controller('DashboardController', ['constants',
  function (constants) {
    this.constants = constants.dashboard;
    this.filterBooks = (filter, query) => filter ? { [filter]: query } : undefined;
    this.bookFilters = [
      {
        value: 'author',
